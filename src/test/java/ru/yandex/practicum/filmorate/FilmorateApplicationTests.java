...
class FilmorateApplicationTests {
    ...
    public void testFilm() {
        ...
        genresList.add(filmStorage.getGenre(1));
        ...
        Film film1 = new Film(1L, "Имя1", "Описание1",
                LocalDate.of(2011, Month.APRIL, 28), 1, 1, filmStorage.getMpa(1), new LinkedHashSet<>(genresList));
        Film film2 = new Film(2L, "Имя2", "Описание2",
                LocalDate.of(1999, Month.AUGUST, 2), 2, 1, filmStorage.getMpa(1), new LinkedHashSet<>(genresList));
        Film film3 = new Film(3L, "Имя3", "Описание3",
                LocalDate.of(1999, Month.AUGUST, 2), 3, 1, filmStorage.getMpa(1), new LinkedHashSet<>(genresList));
        film1.setId(1L);
        film2.setId(2L);
